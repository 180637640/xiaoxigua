...
class ThemePage13 extends StatefulWidget {
  static const int textLength = 1;
  static const int photoLength = 7;

  final int albumPageIndex;
  const ThemePage13({Key? key, required this.albumPageIndex}) : super(key: key);

  @override
  _ThemePage13State createState() => _ThemePage13State();
}

class _ThemePage13State extends State<ThemePage13> {
