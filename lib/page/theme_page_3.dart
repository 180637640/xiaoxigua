...
class ThemePage3 extends StatefulWidget {
  static const int textLength = 1;
  static const int photoLength = 4;

  final int albumPageIndex;
  const ThemePage3({Key? key, required this.albumPageIndex}) : super(key: key);

  @override
  _ThemePage3State createState() => _ThemePage3State();
}

class _ThemePage3State extends State<ThemePage3> {
  @override
